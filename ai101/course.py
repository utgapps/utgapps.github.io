...
CONCEPTS.update({
    ...
    "css:width":         ("css", "width",
        ...
        'width: 100%;'),
    # ---------------- week 7 ----------------
    "css:margin-left":   ("css", "margin-left: auto",
        ...
        'margin-left: auto;'),
    "css:white-space":   ("css", "white-space: pre-wrap",
    ...
    "css:height":        ("css", "height",
        ...
        'height: 340px;'),
    "css:overflow-y":    ("css", "overflow-y: auto",
    ...
    "css:flex-wrap":  ("css", "flex-wrap: wrap",
    ...
    "css:animation":  ("css", "animation",
        ...
        'animation: blink 1s steps(2, start) infinite;'),
    "css:visibility": ("css", "visibility: hidden",
