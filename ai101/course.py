...
# ---------------------------------------------------------------- week 3 ----
{
 ...
 "slides": [
  ...
  {"title": "Checkpoint: the model list", "checkpoint": True, "say": "Press Run and open the Console panel. You should see the list of models the server offers. That list comes from the school AI, so this one needs the classroom network."},
