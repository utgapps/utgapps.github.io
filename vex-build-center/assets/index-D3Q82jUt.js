var kx=Object.defineProperty;var Xx=(o,t,i)=>t in o?kx(o,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):o[t]=i;var ge=(o,t,i)=>Xx(o,typeof t!="symbol"?t+"":t,i);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const h of c.addedNodes)h.tagName==="LINK"&&h.rel==="modulepreload"&&s(h)}).observe(document,{childList:!0,subtree:!0});function i(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(l){if(l.ep)return;l.ep=!0;const c=i(l);fetch(l.href,c)}})();var nh={exports:{}},Lo={};/**
 * @license React
 ...
 */var U_;function Wx(){if(U_)return Lo;U_=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(s,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:o,type:s,key:h,ref:l!==void 0?l:null,props:c}}return Lo.Fragment=t,Lo.jsx=i,Lo.jsxs=i,Lo}var L_;function qx(){return L_||(L_=1,nh.exports=Wx()),nh.exports}var At=qx(),ih={exports:{}},ee={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var N_;function Yx(){if(N_)return ee;N_=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),c=Symbol.for("react.consumer"),h=Symbol.for("react.context"),d=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),y=Symbol.for("react.activity"),x=Symbol.iterator;function M(N){return N===null||typeof N!="object"?null:(N=x&&N[x]||N["@@iterator"],typeof N=="function"?N:null)}var b={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},R=Object.assign,S={};function v(N,at,xt){this.props=N,this.context=at,this.refs=S,this.updater=xt||b}v.prototype.isReactComponent={},v.prototype.setState=function(N,at){if(typeof N!="object"&&typeof N!="function"&&N!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,N,at,"setState")},v.prototype.forceUpdate=function(N){this.updater.enqueueForceUpdate(this,N,"forceUpdate")};function I(){}I.prototype=v.prototype;function O(N,at,xt){this.props=N,this.context=at,this.refs=S,this.updater=xt||b}var L=O.prototype=new I;L.constructor=O,R(L,v.prototype),L.isPureReactComponent=!0;var K=Array.isArray;function G(){}var P={H:null,A:null,T:null,S:null},W=Object.prototype.hasOwnProperty;function D(N,at,xt){var j=xt.ref;return{$$typeof:o,type:N,key:at,ref:j!==void 0?j:null,props:xt}}function C(N,at){return D(N.type,at,N.props)}function w(N){return typeof N=="object"&&N!==null&&N.$$typeof===o}function Q(N){var at={"=":"=0",":":"=2"};return"$"+N.replace(/[=:]/g,function(xt){return at[xt]})}var et=/\/+/g;function mt(N,at){return typeof N=="object"&&N!==null&&N.key!=null?Q(""+N.key):at.toString(36)}function gt(N){switch(N.status){case"fulfilled":return N.value;case"rejected":throw N.reason;default:switch(typeof N.status=="string"?N.then(G,G):(N.status="pending",N.then(function(at){N.status==="pending"&&(N.status="fulfilled",N.value=at)},function(at){N.status==="pending"&&(N.status="rejected",N.reason=at)})),N.status){case"fulfilled":return N.value;case"rejected":throw N.reason}}throw N}function z(N,at,xt,j,ct){var Et=typeof N;(Et==="undefined"||Et==="boolean")&&(N=null);var yt=!1;if(N===null)yt=!0;else switch(Et){case"bigint":case"string":case"number":yt=!0;break;case"object":switch(N.$$typeof){case o:case t:yt=!0;break;case g:return yt=N._init,z(yt(N._payload),at,xt,j,ct)}}if(yt)return ct=ct(N),yt=j===""?"."+mt(N,0):j,K(ct)?(xt="",yt!=null&&(xt=yt.replace(et,"$&/")+"/"),z(ct,at,xt,"",function(ne){return ne})):ct!=null&&(w(ct)&&(ct=C(ct,xt+(ct.key==null||N&&N.key===ct.key?"":(""+ct.key).replace(et,"$&/")+"/")+yt)),at.push(ct)),1;yt=0;var Gt=j===""?".":j+":";if(K(N))for(var Ft=0;Ft<N.length;Ft++)j=N[Ft],Et=Gt+mt(j,Ft),yt+=z(j,at,xt,Et,ct);else if(Ft=M(N),typeof Ft=="function")for(N=Ft.call(N),Ft=0;!(j=N.next()).done;)j=j.value,Et=Gt+mt(j,Ft++),yt+=z(j,at,xt,Et,ct);else if(Et==="object"){if(typeof N.then=="function")return z(gt(N),at,xt,j,ct);throw at=String(N),Error("Objects are not valid as a React child (found: "+(at==="[object Object]"?"object with keys {"+Object.keys(N).join(", ")+"}":at)+"). If you meant to render a collection of children, use an array instead.")}return yt}function J(N,at,xt){if(N==null)return N;var j=[],ct=0;return z(N,j,"","",function(Et){return at.call(xt,Et,ct++)}),j}function Z(N){if(N._status===-1){var at=N._result;at=at(),at.then(function(xt){(N._status===0||N._status===-1)&&(N._status=1,N._result=xt)},function(xt){(N._status===0||N._status===-1)&&(N._status=2,N._result=xt)}),N._status===-1&&(N._status=0,N._result=at)}if(N._status===1)return N._result.default;throw N._result}var St=typeof reportError=="function"?reportError:function(N){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var at=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof N=="object"&&N!==null&&typeof N.message=="string"?String(N.message):String(N),error:N});if(!window.dispatchEvent(at))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",N);return}console.error(N)},Tt={map:J,forEach:function(N,at,xt){J(N,function(){at.apply(this,arguments)},xt)},count:function(N){var at=0;return J(N,function(){at++}),at},toArray:function(N){return J(N,function(at){return at})||[]},only:function(N){if(!w(N))throw Error("React.Children.only expected to receive a single React element child.");return N}};return ee.Activity=y,ee.Children=Tt,ee.Component=v,ee.Fragment=i,ee.Profiler=l,ee.PureComponent=O,ee.StrictMode=s,ee.Suspense=m,ee.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=P,ee.__COMPILER_RUNTIME={__proto__:null,c:function(N){return P.H.useMemoCache(N)}},ee.cache=function(N){return function(){return N.apply(null,arguments)}},ee.cacheSignal=function(){return null},ee.cloneElement=function(N,at,xt){if(N==null)throw Error("The argument must be a React element, but you passed "+N+".");var j=R({},N.props),ct=N.key;if(at!=null)for(Et in at.key!==void 0&&(ct=""+at.key),at)!W.call(at,Et)||Et==="key"||Et==="__self"||Et==="__source"||Et==="ref"&&at.ref===void 0||(j[Et]=at[Et]);var Et=arguments.length-2;if(Et===1)j.children=xt;else if(1<Et){for(var yt=Array(Et),Gt=0;Gt<Et;Gt++)yt[Gt]=arguments[Gt+2];j.children=yt}return D(N.type,ct,j)},ee.createContext=function(N){return N={$$typeof:h,_currentValue:N,_currentValue2:N,_threadCount:0,Provider:null,Consumer:null},N.Provider=N,N.Consumer={$$typeof:c,_context:N},N},ee.createElement=function(N,at,xt){var j,ct={},Et=null;if(at!=null)for(j in at.key!==void 0&&(Et=""+at.key),at)W.call(at,j)&&j!=="key"&&j!=="__self"&&j!=="__source"&&(ct[j]=at[j]);var yt=arguments.length-2;if(yt===1)ct.children=xt;else if(1<yt){for(var Gt=Array(yt),Ft=0;Ft<yt;Ft++)Gt[Ft]=arguments[Ft+2];ct.children=Gt}if(N&&N.defaultProps)for(j in yt=N.defaultProps,yt)ct[j]===void 0&&(ct[j]=yt[j]);return D(N,Et,ct)},ee.createRef=function(){return{current:null}},ee.forwardRef=function(N){return{$$typeof:d,render:N}},ee.isValidElement=w,ee.lazy=function(N){return{$$typeof:g,_payload:{_status:-1,_result:N},_init:Z}},ee.memo=function(N,at){return{$$typeof:p,type:N,compare:at===void 0?null:at}},ee.startTransition=function(N){var at=P.T,xt={};P.T=xt;try{var j=N(),ct=P.S;ct!==null&&ct(xt,j),typeof j=="object"&&j!==null&&typeof j.then=="function"&&j.then(G,St)}catch(Et){St(Et)}finally{at!==null&&xt.types!==null&&(at.types=xt.types),P.T=at}},ee.unstable_useCacheRefresh=function(){return P.H.useCacheRefresh()},ee.use=function(N){return P.H.use(N)},ee.useActionState=function(N,at,xt){return P.H.useActionState(N,at,xt)},ee.useCallback=function(N,at){return P.H.useCallback(N,at)},ee.useContext=function(N){return P.H.useContext(N)},ee.useDebugValue=function(){},ee.useDeferredValue=function(N,at){return P.H.useDeferredValue(N,at)},ee.useEffect=function(N,at){return P.H.useEffect(N,at)},ee.useEffectEvent=function(N){return P.H.useEffectEvent(N)},ee.useId=function(){return P.H.useId()},ee.useImperativeHandle=function(N,at,xt){return P.H.useImperativeHandle(N,at,xt)},ee.useInsertionEffect=function(N,at){return P.H.useInsertionEffect(N,at)},ee.useLayoutEffect=function(N,at){return P.H.useLayoutEffect(N,at)},ee.useMemo=function(N,at){return P.H.useMemo(N,at)},ee.useOptimistic=function(N,at){return P.H.useOptimistic(N,at)},ee.useReducer=function(N,at,xt){return P.H.useReducer(N,at,xt)},ee.useRef=function(N){return P.H.useRef(N)},ee.useState=function(N){return P.H.useState(N)},ee.useSyncExternalStore=function(N,at,xt){return P.H.useSyncExternalStore(N,at,xt)},ee.useTransition=function(){return P.H.useTransition()},ee.version="19.2.8",ee}var O_;function Bd(){return O_||(O_=1,ih.exports=Yx()),ih.exports}var An=Bd(),ah={exports:{}},No={},sh={exports:{}},rh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var P_;function jx(){return P_||(P_=1,(function(o){function t(z,J){var Z=z.length;z.push(J);t:for(;0<Z;){var St=Z-1>>>1,Tt=z[St];if(0<l(Tt,J))z[St]=J,z[Z]=Tt,Z=St;else break t}}function i(z){return z.length===0?null:z[0]}function s(z){if(z.length===0)return null;var J=z[0],Z=z.pop();if(Z!==J){z[0]=Z;t:for(var St=0,Tt=z.length,N=Tt>>>1;St<N;){var at=2*(St+1)-1,xt=z[at],j=at+1,ct=z[j];if(0>l(xt,Z))j<Tt&&0>l(ct,xt)?(z[St]=ct,z[j]=Z,St=j):(z[St]=xt,z[at]=Z,St=at);else if(j<Tt&&0>l(ct,Z))z[St]=ct,z[j]=Z,St=j;else break t}}return J}function l(z,J){var Z=z.sortIndex-J.sortIndex;return Z!==0?Z:z.id-J.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;o.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();o.unstable_now=function(){return h.now()-d}}var m=[],p=[],g=1,y=null,x=3,M=!1,b=!1,R=!1,S=!1,v=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,O=typeof setImmediate<"u"?setImmediate:null;function L(z){for(var J=i(p);J!==null;){if(J.callback===null)s(p);else if(J.startTime<=z)s(p),J.sortIndex=J.expirationTime,t(m,J);else break;J=i(p)}}function K(z){if(R=!1,L(z),!b)if(i(m)!==null)b=!0,G||(G=!0,Q());else{var J=i(p);J!==null&&gt(K,J.startTime-z)}}var G=!1,P=-1,W=5,D=-1;function C(){return S?!0:!(o.unstable_now()-D<W)}function w(){if(S=!1,G){var z=o.unstable_now();D=z;var J=!0;try{t:{b=!1,R&&(R=!1,I(P),P=-1),M=!0;var Z=x;try{e:{for(L(z),y=i(m);y!==null&&!(y.expirationTime>z&&C());){var St=y.callback;if(typeof St=="function"){y.callback=null,x=y.priorityLevel;var Tt=St(y.expirationTime<=z);if(z=o.unstable_now(),typeof Tt=="function"){y.callback=Tt,L(z),J=!0;break e}y===i(m)&&s(m),L(z)}else s(m);y=i(m)}if(y!==null)J=!0;else{var N=i(p);N!==null&&gt(K,N.startTime-z),J=!1}}break t}finally{y=null,x=Z,M=!1}J=void 0}}finally{J?Q():G=!1}}}var Q;if(typeof O=="function")Q=function(){O(w)};else if(typeof MessageChannel<"u"){var et=new MessageChannel,mt=et.port2;et.port1.onmessage=w,Q=function(){mt.postMessage(null)}}else Q=function(){v(w,0)};function gt(z,J){P=v(function(){z(o.unstable_now())},J)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(z){z.callback=null},o.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<z?Math.floor(1e3/z):5},o.unstable_getCurrentPriorityLevel=function(){return x},o.unstable_next=function(z){switch(x){case 1:case 2:case 3:var J=3;break;default:J=x}var Z=x;x=J;try{return z()}finally{x=Z}},o.unstable_requestPaint=function(){S=!0},o.unstable_runWithPriority=function(z,J){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var Z=x;x=z;try{return J()}finally{x=Z}},o.unstable_scheduleCallback=function(z,J,Z){var St=o.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?St+Z:St):Z=St,z){case 1:var Tt=-1;break;case 2:Tt=250;break;case 5:Tt=1073741823;break;case 4:Tt=1e4;break;default:Tt=5e3}return Tt=Z+Tt,z={id:g++,callback:J,priorityLevel:z,startTime:Z,expirationTime:Tt,sortIndex:-1},Z>St?(z.sortIndex=Z,t(p,z),i(m)===null&&z===i(p)&&(R?(I(P),P=-1):R=!0,gt(K,Z-St))):(z.sortIndex=Tt,t(m,z),b||M||(b=!0,G||(G=!0,Q()))),z},o.unstable_shouldYield=C,o.unstable_wrapCallback=function(z){var J=x;return function(){var Z=x;x=J;try{return z.apply(this,arguments)}finally{x=Z}}}})(rh)),rh}var z_;function Zx(){return z_||(z_=1,sh.exports=jx()),sh.exports}var oh={exports:{}},wn={};/**
 * @license React
...
void main() {
	...
	`}function xb(o){let t=new WeakMap,i=null;function s(d){if(d&&d.isTexture){const m=d.mapping,p=m===ad||m===sd,g=m===Lr||m===Nr;if(p||g){let y=t.get(d);const x=y!==void 0?y.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==x)return i===null&&(i=new T0(o)),y=p?i.fromEquirectangular(d,y):i.fromCubemap(d,y),y.texture.pmremVersion=d.pmremVersion,t.set(d,y),y.texture;if(y!==void 0)return y.texture;{const M=d.image;return p&&M&&M.height>0||g&&M&&l(M)?(i===null&&(i=new T0(o)),y=p?i.fromEquirectangular(d):i.fromCubemap(d),y.texture.pmremVersion=d.pmremVersion,t.set(d,y),d.addEventListener("dispose",c),y.texture):null}}}return d}function l(d){let m=0;const p=6;for(let g=0;g<p;g++)d[g]!==void 0&&m++;return m===p}function c(d){const m=d.target;m.removeEventListener("dispose",c);const p=t.get(m);p!==void 0&&(t.delete(m),p.dispose())}function h(){t=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:h}}function Sb(o){const t={};function i(s){if(t[s]!==void 0)return t[s];let l;switch(s){case"WEBGL_depth_texture":l=o.getExtension("WEBGL_depth_texture")||o.getExtension("MOZ_WEBGL_depth_texture")||o.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":l=o.getExtension("EXT_texture_filter_anisotropic")||o.getExtension("MOZ_EXT_texture_filter_anisotropic")||o.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":l=o.getExtension("WEBGL_compressed_texture_s3tc")||o.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":l=o.getExtension("WEBGL_compressed_texture_pvrtc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:l=o.getExtension(s)}return t[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Tr("THREE.WebGLRenderer: "+s+" extension not supported."),l}}}function Mb(o,t,i,s){const l={},c=new WeakMap;function h(y){const x=y.target;x.index!==null&&t.remove(x.index);for(const b in x.attributes)t.remove(x.attributes[b]);x.removeEventListener("dispose",h),delete l[x.id];const M=c.get(x);M&&(t.remove(M),c.delete(x)),s.releaseStatesOfGeometry(x),x.isInstancedBufferGeometry===!0&&delete x._maxInstanceCount,i.memory.geometries--}function d(y,x){return l[x.id]===!0||(x.addEventListener("dispose",h),l[x.id]=!0,i.memory.geometries++),x}function m(y){const x=y.attributes;for(const M in x)t.update(x[M],o.ARRAY_BUFFER)}function p(y){const x=[],M=y.index,b=y.attributes.position;let R=0;if(M!==null){const I=M.array;R=M.version;for(let O=0,L=I.length;O<L;O+=3){const K=I[O+0],G=I[O+1],P=I[O+2];x.push(K,G,G,P,P,K)}}else if(b!==void 0){const I=b.array;R=b.version;for(let O=0,L=I.length/3-1;O<L;O+=3){const K=O+0,G=O+1,P=O+2;x.push(K,G,G,P,P,K)}}else return;const S=new(mv(x)?xv:yv)(x,1);S.version=R;const v=c.get(y);v&&t.remove(v),c.set(y,S)}function g(y){const x=c.get(y);if(x){const M=y.index;M!==null&&x.version<M.version&&p(y)}else p(y);return c.get(y)}return{get:d,update:m,getWireframeAttribute:g}}function Eb(o,t,i){let s;function l(x){s=x}let c,h;function d(x){c=x.type,h=x.bytesPerElement}function m(x,M){o.drawElements(s,M,c,x*h),i.update(M,s,1)}function p(x,M,b){b!==0&&(o.drawElementsInstanced(s,M,c,x*h,b),i.update(M,s,b))}function g(x,M,b){if(b===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,M,0,c,x,0,b);let S=0;for(let v=0;v<b;v++)S+=M[v];i.update(S,s,1)}function y(x,M,b,R){if(b===0)return;const S=t.get("WEBGL_multi_draw");if(S===null)for(let v=0;v<x.length;v++)p(x[v]/h,M[v],R[v]);else{S.multiDrawElementsInstancedWEBGL(s,M,0,c,x,0,R,0,b);let v=0;for(let I=0;I<b;I++)v+=M[I]*R[I];i.update(v,s,1)}}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=g,this.renderMultiDrawInstances=y}function Tb(o){const t={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,h,d){switch(i.calls++,h){case o.TRIANGLES:i.triangles+=d*(c/3);break;case o.LINES:i.lines+=d*(c/2);break;case o.LINE_STRIP:i.lines+=d*(c-1);break;case o.LINE_LOOP:i.lines+=d*c;break;case o.POINTS:i.points+=d*c;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",h);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:t,render:i,programs:null,autoReset:!0,reset:l,update:s}}function bb(o,t,i){const s=new WeakMap,l=new $e;function c(h,d,m){const p=h.morphTargetInfluences,g=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,y=g!==void 0?g.length:0;let x=s.get(d);if(x===void 0||x.count!==y){let C=function(){W.dispose(),s.delete(d),d.removeEventListener("dispose",C)};var M=C;x!==void 0&&x.texture.dispose();const b=d.morphAttributes.position!==void 0,R=d.morphAttributes.normal!==void 0,S=d.morphAttributes.color!==void 0,v=d.morphAttributes.position||[],I=d.morphAttributes.normal||[],O=d.morphAttributes.color||[];let L=0;b===!0&&(L=1),R===!0&&(L=2),S===!0&&(L=3);let K=d.attributes.position.count*L,G=1;K>t.maxTextureSize&&(G=Math.ceil(K/t.maxTextureSize),K=t.maxTextureSize);const P=new Float32Array(K*G*4*y),W=new _v(P,K,G,y);W.type=ua,W.needsUpdate=!0;const D=L*4;for(let w=0;w<y;w++){const Q=v[w],et=I[w],mt=O[w],gt=K*G*4*w;for(let z=0;z<Q.count;z++){const J=z*D;b===!0&&(l.fromBufferAttribute(Q,z),P[gt+J+0]=l.x,P[gt+J+1]=l.y,P[gt+J+2]=l.z,P[gt+J+3]=0),R===!0&&(l.fromBufferAttribute(et,z),P[gt+J+4]=l.x,P[gt+J+5]=l.y,P[gt+J+6]=l.z,P[gt+J+7]=0),S===!0&&(l.fromBufferAttribute(mt,z),P[gt+J+8]=l.x,P[gt+J+9]=l.y,P[gt+J+10]=l.z,P[gt+J+11]=mt.itemSize===4?l.w:1)}}x={count:y,texture:W,size:new ie(K,G)},s.set(d,x),d.addEventListener("dispose",C)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)m.getUniforms().setValue(o,"morphTexture",h.morphTexture,i);else{let b=0;for(let S=0;S<p.length;S++)b+=p[S];const R=d.morphTargetsRelative?1:1-b;m.getUniforms().setValue(o,"morphTargetBaseInfluence",R),m.getUniforms().setValue(o,"morphTargetInfluences",p)}m.getUniforms().setValue(o,"morphTargetsTexture",x.texture,i),m.getUniforms().setValue(o,"morphTargetsTextureSize",x.size)}return{update:c}}function Ab(o,t,i,s){let l=new WeakMap;function c(m){const p=s.render.frame,g=m.geometry,y=t.get(m,g);if(l.get(y)!==p&&(t.update(y),l.set(y,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",d)===!1&&m.addEventListener("dispose",d),l.get(m)!==p&&(i.update(m.instanceMatrix,o.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,o.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const x=m.skeleton;l.get(x)!==p&&(x.update(),l.set(x,p))}return y}function h(){l=new WeakMap}function d(m){const p=m.target;p.removeEventListener("dispose",d),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:h}}const Dv=new jn,C0=new Av(1,1),Uv=new _v,Lv=new JS,Nv=new Ev,w0=[],D0=[],U0=new Float32Array(16),L0=new Float32Array(9),N0=new Float32Array(4);function Fr(o,t,i){const s=o[0];if(s<=0||s>0)return o;const l=t*i;let c=w0[l];if(c===void 0&&(c=new Float32Array(l),w0[l]=c),t!==0){s.toArray(c,0);for(let h=1,d=0;h!==t;++h)d+=i,o[h].toArray(c,d)}return c}function pn(o,t){if(o.length!==t.length)return!1;for(let i=0,s=o.length;i<s;i++)if(o[i]!==t[i])return!1;return!0}function mn(o,t){for(let i=0,s=t.length;i<s;i++)o[i]=t[i]}function jc(o,t){let i=D0[t];i===void 0&&(i=new Int32Array(t),D0[t]=i);for(let s=0;s!==t;++s)i[s]=o.allocateTextureUnit();return i}function Rb(o,t){const i=this.cache;i[0]!==t&&(o.uniform1f(this.addr,t),i[0]=t)}function Cb(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(o.uniform2f(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(pn(i,t))return;o.uniform2fv(this.addr,t),mn(i,t)}}function wb(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(o.uniform3f(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else if(t.r!==void 0)(i[0]!==t.r||i[1]!==t.g||i[2]!==t.b)&&(o.uniform3f(this.addr,t.r,t.g,t.b),i[0]=t.r,i[1]=t.g,i[2]=t.b);else{if(pn(i,t))return;o.uniform3fv(this.addr,t),mn(i,t)}}function Db(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(o.uniform4f(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(pn(i,t))return;o.uniform4fv(this.addr,t),mn(i,t)}}function Ub(o,t){const i=this.cache,s=t.elements;if(s===void 0){if(pn(i,t))return;o.uniformMatrix2fv(this.addr,!1,t),mn(i,t)}else{if(pn(i,s))return;N0.set(s),o.uniformMatrix2fv(this.addr,!1,N0),mn(i,s)}}function Lb(o,t){const i=this.cache,s=t.elements;if(s===void 0){if(pn(i,t))return;o.uniformMatrix3fv(this.addr,!1,t),mn(i,t)}else{if(pn(i,s))return;L0.set(s),o.uniformMatrix3fv(this.addr,!1,L0),mn(i,s)}}function Nb(o,t){const i=this.cache,s=t.elements;if(s===void 0){if(pn(i,t))return;o.uniformMatrix4fv(this.addr,!1,t),mn(i,t)}else{if(pn(i,s))return;U0.set(s),o.uniformMatrix4fv(this.addr,!1,U0),mn(i,s)}}function Ob(o,t){const i=this.cache;i[0]!==t&&(o.uniform1i(this.addr,t),i[0]=t)}function Pb(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(o.uniform2i(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(pn(i,t))return;o.uniform2iv(this.addr,t),mn(i,t)}}function zb(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(o.uniform3i(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(pn(i,t))return;o.uniform3iv(this.addr,t),mn(i,t)}}function Bb(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(o.uniform4i(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(pn(i,t))return;o.uniform4iv(this.addr,t),mn(i,t)}}function Ib(o,t){const i=this.cache;i[0]!==t&&(o.uniform1ui(this.addr,t),i[0]=t)}function Fb(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y)&&(o.uniform2ui(this.addr,t.x,t.y),i[0]=t.x,i[1]=t.y);else{if(pn(i,t))return;o.uniform2uiv(this.addr,t),mn(i,t)}}function Hb(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z)&&(o.uniform3ui(this.addr,t.x,t.y,t.z),i[0]=t.x,i[1]=t.y,i[2]=t.z);else{if(pn(i,t))return;o.uniform3uiv(this.addr,t),mn(i,t)}}function Gb(o,t){const i=this.cache;if(t.x!==void 0)(i[0]!==t.x||i[1]!==t.y||i[2]!==t.z||i[3]!==t.w)&&(o.uniform4ui(this.addr,t.x,t.y,t.z,t.w),i[0]=t.x,i[1]=t.y,i[2]=t.z,i[3]=t.w);else{if(pn(i,t))return;o.uniform4uiv(this.addr,t),mn(i,t)}}function Vb(o,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(o.uniform1i(this.addr,l),s[0]=l);let c;this.type===o.SAMPLER_2D_SHADOW?(C0.compareFunction=pv,c=C0):c=Dv,i.setTexture2D(t||c,l)}function kb(o,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(o.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(t||Lv,l)}function Xb(o,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(o.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(t||Nv,l)}function Wb(o,t,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(o.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(t||Uv,l)}function qb(o){switch(o){case 5126:return Rb;case 35664:return Cb;case 35665:return wb;case 35666:return Db;case 35674:return Ub;case 35675:return Lb;case 35676:return Nb;case 5124:case 35670:return Ob;case 35667:case 35671:return Pb;case 35668:case 35672:return zb;case 35669:case 35673:return Bb;case 5125:return Ib;case 36294:return Fb;case 36295:return Hb;case 36296:return Gb;case 35678:case 36198:case 36298:case 36306:case 35682:return Vb;case 35679:case 36299:case 36307:return kb;case 35680:case 36300:case 36308:case 36293:return Xb;case 36289:case 36303:case 36311:case 36292:return Wb}}function Yb(o,t){o.uniform1fv(this.addr,t)}function jb(o,t){const i=Fr(t,this.size,2);o.uniform2fv(this.addr,i)}function Zb(o,t){const i=Fr(t,this.size,3);o.uniform3fv(this.addr,i)}function Kb(o,t){const i=Fr(t,this.size,4);o.uniform4fv(this.addr,i)}function Qb(o,t){const i=Fr(t,this.size,4);o.uniformMatrix2fv(this.addr,!1,i)}function Jb(o,t){const i=Fr(t,this.size,9);o.uniformMatrix3fv(this.addr,!1,i)}function $b(o,t){const i=Fr(t,this.size,16);o.uniformMatrix4fv(this.addr,!1,i)}function tA(o,t){o.uniform1iv(this.addr,t)}function eA(o,t){o.uniform2iv(this.addr,t)}function nA(o,t){o.uniform3iv(this.addr,t)}function iA(o,t){o.uniform4iv(this.addr,t)}function aA(o,t){o.uniform1uiv(this.addr,t)}function sA(o,t){o.uniform2uiv(this.addr,t)}function rA(o,t){o.uniform3uiv(this.addr,t)}function oA(o,t){o.uniform4uiv(this.addr,t)}function lA(o,t,i){const s=this.cache,l=t.length,c=jc(i,l);pn(s,c)||(o.uniform1iv(this.addr,c),mn(s,c));for(let h=0;h!==l;++h)i.setTexture2D(t[h]||Dv,c[h])}function cA(o,t,i){const s=this.cache,l=t.length,c=jc(i,l);pn(s,c)||(o.uniform1iv(this.addr,c),mn(s,c));for(let h=0;h!==l;++h)i.setTexture3D(t[h]||Lv,c[h])}function uA(o,t,i){const s=this.cache,l=t.length,c=jc(i,l);pn(s,c)||(o.uniform1iv(this.addr,c),mn(s,c));for(let h=0;h!==l;++h)i.setTextureCube(t[h]||Nv,c[h])}function fA(o,t,i){const s=this.cache,l=t.length,c=jc(i,l);pn(s,c)||(o.uniform1iv(this.addr,c),mn(s,c));for(let h=0;h!==l;++h)i.setTexture2DArray(t[h]||Uv,c[h])}function hA(o){switch(o){case 5126:return Yb;case 35664:return jb;case 35665:return Zb;case 35666:return Kb;case 35674:return Qb;case 35675:return Jb;case 35676:return $b;case 5124:case 35670:return tA;case 35667:case 35671:return eA;case 35668:case 35672:return nA;case 35669:case 35673:return iA;case 5125:return aA;case 36294:return sA;case 36295:return rA;case 36296:return oA;case 35678:case 36198:case 36298:case 36306:case 35682:return lA;case 35679:case 36299:case 36307:return cA;case 35680:case 36300:case 36308:case 36293:return uA;case 36289:case 36303:case 36311:case 36292:return fA}}class dA{constructor(t,i,s){this.id=t,this.addr=s,this.cache=[],this.type=i.type,this.setValue=qb(i.type)}}class pA{constructor(t,i,s){this.id=t,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=hA(i.type)}}class mA{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,i,s){const l=this.seq;for(let c=0,h=l.length;c!==h;++c){const d=l[c];d.setValue(t,i[d.id],s)}}}const Ih=/(\w+)(\])?(\[|\.)?/g;function O0(o,t){o.seq.push(t),o.map[t.id]=t}function gA(o,t,i){const s=o.name,l=s.length;for(Ih.lastIndex=0;;){const c=Ih.exec(s),h=Ih.lastIndex;let d=c[1];const m=c[2]==="]",p=c[3];if(m&&(d=d|0),p===void 0||p==="["&&h+2===l){O0(i,p===void 0?new dA(d,o,t):new pA(d,o,t));break}else{let y=i.map[d];y===void 0&&(y=new mA(d),O0(i,y)),i=y}}}class zc{constructor(t,i){this.seq=[],this.map={};const s=t.getProgramParameter(i,t.ACTIVE_UNIFORMS);for(let l=0;l<s;++l){const c=t.getActiveUniform(i,l),h=t.getUniformLocation(i,c.name);gA(c,h,this)}}setValue(t,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(t,s,l)}setOptional(t,i,s){const l=i[s];l!==void 0&&this.setValue(t,s,l)}static upload(t,i,s,l){for(let c=0,h=i.length;c!==h;++c){const d=i[c],m=s[d.id];m.needsUpdate!==!1&&d.setValue(t,m.value,l)}}static seqWithValue(t,i){const s=[];for(let l=0,c=t.length;l!==c;++l){const h=t[l];h.id in i&&s.push(h)}return s}}function P0(o,t,i){const s=o.createShader(t);return o.shaderSource(s,i),o.compileShader(s),s}const _A=37297;let vA=0;function yA(o,t){const i=o.split(`
`),s=[],l=Math.max(t-6,0),c=Math.min(t+6,i.length);for(let h=l;h<c;h++){const d=h+1;s.push(`${d===t?">":" "} ${d}: ${i[h]}`)}return s.join(`
`)}const z0=new le;function xA(o){we._getMatrix(z0,we.workingColorSpace,o);const t=`mat3( ${z0.elements.map(i=>i.toFixed(4))} )`;switch(we.getTransfer(o)){case Bc:return[t,"LinearTransferOETF"];case Fe:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",o),[t,"LinearTransferOETF"]}}function B0(o,t,i){const s=o.getShaderParameter(t,o.COMPILE_STATUS),l=o.getShaderInfoLog(t).trim();if(s&&l==="")return"";const c=/ERROR: 0:(\d+)/.exec(l);if(c){const h=parseInt(c[1]);return i.toUpperCase()+`
...
`)+`
`+v);const O=I+S+h,L=I+v+d,K=P0(l,l.VERTEX_SHADER,O),G=P0(l,l.FRAGMENT_SHADER,L);l.attachShader(R,K),l.attachShader(R,G),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function P(w){if(o.debug.checkShaderErrors){const Q=l.getProgramInfoLog(R).trim(),et=l.getShaderInfoLog(K).trim(),mt=l.getShaderInfoLog(G).trim();let gt=!0,z=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(gt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,R,K,G);else{const J=B0(l,K,"vertex"),Z=B0(l,G,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
