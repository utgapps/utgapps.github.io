...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Wa,depthTest:!1,depthWrite:!1})}function R0(){return new ja({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Kd(),fragmentShader:`
		...
		`,blending:Wa,depthTest:!1,depthWrite:!1})}function C0(){return new ja({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Kd(),fragmentShader:`
...
`)+`
`+y);const O=I+S+h,L=I+y+d,Q=z0(l,l.VERTEX_SHADER,O),G=z0(l,l.FRAGMENT_SHADER,L);l.attachShader(R,Q),l.attachShader(R,G),i.index0AttributeName!==void 0?l.bindAttribLocation(R,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(R,0,"position"),l.linkProgram(R);function P(w){if(o.debug.checkShaderErrors){const j=l.getProgramInfoLog(R).trim(),et=l.getShaderInfoLog(Q).trim(),mt=l.getShaderInfoLog(G).trim();let gt=!0,z=!0;if(l.getProgramParameter(R,l.LINK_STATUS)===!1)if(gt=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,R,Q,G);else{const J=I0(l,Q,"vertex"),K=I0(l,G,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(R,l.VALIDATE_STATUS)+`
